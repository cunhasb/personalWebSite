...
export default class ParallaxHover extends Component {
  ...
  renderLayers() {
    ...
    if (!Array.isArray(children)) {
      return (
        <div style={_styles} className={css(styles.parallaxHover__layer)}>
          {children}
        </div>
      );
    }
  ...
  render() {
    ...
    const shadowPositionModifier = isHovered
    ...
    const _styles = {
      ...
      lighting: {
        backgroundImage: `linear-gradient(${angle}deg, rgba(255,255,255, ${shine /
          10}) 0%, rgba(255,255,255,0) 50%)`,
        borderRadius: `${borderRadius}px`,
        ...this.buildTransformStrings()
      },
    ...
    return (
      ...
      >
        <div
          className={css(styles.parallaxHover__shadow)}
          style={_styles.shadow}
        />
        <div className={css(styles.parallaxHover__container)}>
          {this.renderLayers()}
          <div
            className={css(styles.parallaxHover__lighting)}
